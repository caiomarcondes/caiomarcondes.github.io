...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xa(){return new Ai({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Qa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Za(){return new Ai({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Qa(),fragmentShader:`
	...
	`}var $a=class extends tn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new gi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Ts={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Es(e,t){let n=Ts[t];return n===void 0?(H(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Ds=new K;function Os(){return J.getLuminanceCoefficients(Ds),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Ds.x.toFixed(4)}, ${Ds.y.toFixed(4)}, ${Ds.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=_s(i,i.VERTEX_SHADER,y),S=_s(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Cs(i,x,`vertex`),n=Cs(i,S,`fragment`);U(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
#endif
#include <dithering_fragment>
}`,cl=`uniform vec2 resolution;uniform vec2 texelSize;uniform float cameraNear;uniform float cameraFar;uniform float aspect;uniform float time;varying vec2 vUv;VERTEX_HEAD void main(){vUv=position.xy*0.5+0.5;VERTEX_MAIN_SUPPORT gl_Position=vec4(position.xy,1.0,1.0);}`,ll=class extends Ai{constructor(e,t,n,r,i=!1){super({name:`EffectMaterial`,defines:{THREE_REVISION:`185`.replace(/\D+/g,``),DEPTH_PACKING:`0`,ENCODE_OUTPUT:`1`},uniforms:{inputBuffer:new ya(null),depthBuffer:new ya(null),resolution:new ya(new G),texelSize:new ya(new G),cameraNear:new ya(.3),cameraFar:new ya(1e3),aspect:new ya(1),time:new ya(0)},blending:0,toneMapped:!1,depthWrite:!1,depthTest:!1,dithering:i}),e&&this.setShaderParts(e),t&&this.setDefines(t),n&&this.setUniforms(n),this.copyCameraSettings(r)}set inputBuffer(e){this.uniforms.inputBuffer.value=e}setInputBuffer(e){this.uniforms.inputBuffer.value=e}get depthBuffer(){return this.uniforms.depthBuffer.value}set depthBuffer(e){this.uniforms.depthBuffer.value=e}get depthPacking(){return Number(this.defines.DEPTH_PACKING)}set depthPacking(e){this.defines.DEPTH_PACKING=e.toFixed(0),this.needsUpdate=!0}setDepthBuffer(e,t=ct){this.depthBuffer=e,this.depthPacking=t}setShaderData(e){this.setShaderParts(e.shaderParts),this.setDefines(e.defines),this.setUniforms(e.uniforms),this.setExtensions(e.extensions)}setShaderParts(e){return this.fragmentShader=sl.replace(Q.FRAGMENT_HEAD,e.get(Q.FRAGMENT_HEAD)||``).replace(Q.FRAGMENT_MAIN_UV,e.get(Q.FRAGMENT_MAIN_UV)||``).replace(Q.FRAGMENT_MAIN_IMAGE,e.get(Q.FRAGMENT_MAIN_IMAGE)||``),this.vertexShader=cl.replace(Q.VERTEX_HEAD,e.get(Q.VERTEX_HEAD)||``).replace(Q.VERTEX_MAIN_SUPPORT,e.get(Q.VERTEX_MAIN_SUPPORT)||``),this.needsUpdate=!0,this}setDefines(e){for(let t of e.entries())this.defines[t[0]]=t[1];return this.needsUpdate=!0,this}setUniforms(e){for(let t of e.entries())this.uniforms[t[0]]=t[1];return this}setExtensions(e){this.extensions={};for(let t of e)this.extensions[t]=!0;return this}get encodeOutput(){return this.defines.ENCODE_OUTPUT!==void 0}set encodeOutput(e){this.encodeOutput!==e&&(e?this.defines.ENCODE_OUTPUT=`1`:delete this.defines.ENCODE_OUTPUT,this.needsUpdate=!0)}isOutputEncodingEnabled(e){return this.encodeOutput}setOutputEncodingEnabled(e){this.encodeOutput=e}get time(){return this.uniforms.time.value}set time(e){this.uniforms.time.value=e}setDeltaTime(e){this.uniforms.time.value+=e}adoptCameraSettings(e){this.copyCameraSettings(e)}copyCameraSettings(e){e&&(this.uniforms.cameraNear.value=e.near,this.uniforms.cameraFar.value=e.far,e instanceof ta?this.defines.PERSPECTIVE_CAMERA=`1`:delete this.defines.PERSPECTIVE_CAMERA,this.needsUpdate=!0)}setSize(e,t){let n=this.uniforms;n.resolution.value.set(e,t),n.texelSize.value.set(1/e,1/t),n.aspect.value=e/t}static get Section(){return Q}};Number(`185`.replace(/\D+/g,``));var ul=255/256;new Float32Array([ul/256**3,ul/256**2,ul/256,ul]),new Float32Array([ul,ul/256,ul/256**2,1/256**3]);function dl(e,t,n){for(let r of t){let t=`$1`+e+r.charAt(0).toUpperCase()+r.slice(1),i=RegExp(`([^\\.])(\\b`+r+`\\b)`,`g`);for(let e of n.entries())e[1]!==null&&n.set(e[0],e[1].replace(i,t))}}function fl(e,t,n){let r=t.getFragmentShader(),i=t.getVertexShader(),a=r!==void 0&&/mainImage/.test(r),o=r!==void 0&&/mainUv/.test(r);if(n.attributes|=t.getAttributes(),r===void 0)throw Error(`Missing fragment shader (${t.name})`);if(o&&(n.attributes&$c.CONVOLUTION)!==0)throw Error(`Effects that transform UVs are incompatible with convolution effects (${t.name})`);if(!a&&!o)throw Error(`Could not find mainImage or mainUv function (${t.name})`);{let s=/\w+\s+(\w+)\([\w\s,]*\)\s*{/g,c=n.shaderParts,l=c.get(Q.FRAGMENT_HEAD)||``,u=c.get(Q.FRAGMENT_MAIN_UV)||``,d=c.get(Q.FRAGMENT_MAIN_IMAGE)||``,f=c.get(Q.VERTEX_HEAD)||``,p=c.get(Q.VERTEX_MAIN_SUPPORT)||``,m=new Set,h=new Set;if(o&&(u+=`	${e}MainUv(UV);
`,n.uvTransformation=!0),i!==null&&/mainSupport/.test(i)){let t=/mainSupport *\([\w\s]*?uv\s*?\)/.test(i);p+=`	${e}MainSupport(`,p+=t?`vUv);
`:`);
`;for(let e of i.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))for(let t of e[1].split(/\s*,\s*/))n.varyings.add(t),m.add(t),h.add(t);for(let e of i.matchAll(s))h.add(e[1])}for(let e of r.matchAll(s))h.add(e[1]);for(let e of t.defines.keys())h.add(e.replace(/\([\w\s,]*\)/g,``));for(let e of t.uniforms.keys())h.add(e);h.delete(`while`),h.delete(`for`),h.delete(`if`),t.uniforms.forEach((t,r)=>n.uniforms.set(e+r.charAt(0).toUpperCase()+r.slice(1),t)),t.defines.forEach((t,r)=>n.defines.set(e+r.charAt(0).toUpperCase()+r.slice(1),t));let g=new Map([[`fragment`,r],[`vertex`,i]]);dl(e,h,n.defines),dl(e,h,g),r=g.get(`fragment`),i=g.get(`vertex`);let _=t.blendMode;if(n.blendModes.set(_.blendFunction,_),a){t.inputColorSpace!==null&&t.inputColorSpace!==n.colorSpace&&(d+=t.inputColorSpace===`srgb`?`color0 = sRGBTransferOETF(color0);
	`:`color0 = sRGBToLinear(color0);
	`),t.outputColorSpace===``?t.inputColorSpace!==null&&(n.colorSpace=t.inputColorSpace):n.colorSpace=t.outputColorSpace,d+=`${e}MainImage(color0, UV, `,(n.attributes&$c.DEPTH)!==0&&/MainImage *\([\w\s,]*?depth[\w\s,]*?\)/.test(r)&&(d+=`depth, `,n.readDepth=!0),d+=`color1);
...
#`));this.skipRendering=t===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(e)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(e,t=ct){this.fullscreenMaterial.depthBuffer=e,this.fullscreenMaterial.depthPacking=t;for(let n of this.effects)n.setDepthTexture(e,t)}render(e,t,n,r,i){for(let n of this.effects)n.update(e,t,r);if(!this.skipRendering||this.renderToScreen){let i=this.fullscreenMaterial;i.inputBuffer=t.texture,i.time+=r*this.timeScale,e.setRenderTarget(this.renderToScreen?null:n),e.render(this.scene,this.camera)}}setSize(e,t){this.fullscreenMaterial.setSize(e,t);for(let n of this.effects)n.setSize(e,t)}initialize(e,t,n){this.renderer=e;for(let r of this.effects)r.initialize(e,t,n);this.updateMaterial(),n!==void 0&&n!==1009&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`)}dispose(){super.dispose();for(let e of this.effects)e.removeEventListener(`change`,this.listener),e.dispose()}handleEvent(e){e.type===`change`&&this.recompile()}};new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,0,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([1,0,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([0,1,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([0,1,1]),new Float32Array([1,1,1]),new Float32Array([0,-.25,.25,-.125,.125,-.375,.375]),new Float32Array([0,0]),new Float32Array([.25,-.25]),new Float32Array([-.25,.25]),new Float32Array([.125,-.125]),new Float32Array([-.125,.125]),new Uint8Array([0,0]),new Uint8Array([3,0]),new Uint8Array([0,3]),new Uint8Array([3,3]),new Uint8Array([1,0]),new Uint8Array([4,0]),new Uint8Array([1,3]),new Uint8Array([4,3]),new Uint8Array([0,1]),new Uint8Array([3,1]),new Uint8Array([0,4]),new Uint8Array([3,4]),new Uint8Array([1,1]),new Uint8Array([4,1]),new Uint8Array([1,4]),new Uint8Array([4,4]),new Uint8Array([0,0]),new Uint8Array([1,0]),new Uint8Array([0,2]),new Uint8Array([1,2]),new Uint8Array([2,0]),new Uint8Array([3,0]),new Uint8Array([2,2]),new Uint8Array([3,2]),new Uint8Array([0,1]),new Uint8Array([1,1]),new Uint8Array([0,3]),new Uint8Array([1,3]),new Uint8Array([2,1]),new Uint8Array([3,1]),new Uint8Array([2,3]),new Uint8Array([3,3]),hl(0,0,0,0),new Float32Array([0,0,0,0]),hl(0,0,0,1),new Float32Array([0,0,0,1]),hl(0,0,1,0),new Float32Array([0,0,1,0]),hl(0,0,1,1),new Float32Array([0,0,1,1]),hl(0,1,0,0),new Float32Array([0,1,0,0]),hl(0,1,0,1),new Float32Array([0,1,0,1]),hl(0,1,1,0),new Float32Array([0,1,1,0]),hl(0,1,1,1),new Float32Array([0,1,1,1]),hl(1,0,0,0),new Float32Array([1,0,0,0]),hl(1,0,0,1),new Float32Array([1,0,0,1]),hl(1,0,1,0),new Float32Array([1,0,1,0]),hl(1,0,1,1),new Float32Array([1,0,1,1]),hl(1,1,0,0),new Float32Array([1,1,0,0]),hl(1,1,0,1),new Float32Array([1,1,0,1]),hl(1,1,1,0),new Float32Array([1,1,1,0]),hl(1,1,1,1),new Float32Array([1,1,1,1]);function ml(e,t,n){return e+(t-e)*n}function hl(e,t,n,r){return ml(ml(e,t,.75),ml(n,r,.75),.875)}var gl=()=>{let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`);if(!t)throw Error(`2D context not available`);t.fillStyle=`black`,t.fillRect(0,0,e.width,e.height);let n=new Qt(e);n.minFilter=P,n.magFilter=P,n.generateMipmaps=!1;let r=[],i=null,a=6.4,o=()=>{t.fillStyle=`black`,t.fillRect(0,0,e.width,e.height)},s=e=>{let n={x:e.x*64,y:(1-e.y)*64},r=1;r=e.age<19.2?(e=>Math.sin(e*Math.PI/2))(e.age/19.2):(e=>-e*(e-2))(1-(e.age-19.2)/44.8)||0,r*=e.force;let i=`${(e.vx+1)/2*255}, ${(e.vy+1)/2*255}, ${r*255}`;t.shadowOffsetX=320,t.shadowOffsetY=320,t.shadowBlur=a,t.shadowColor=`rgba(${i},${.22*r})`,t.beginPath(),t.fillStyle=`rgba(255,0,0,1)`,t.arc(n.x-320,n.y-320,a,0,Math.PI*2),t.fill()};return{canvas:e,texture:n,addTouch:e=>{let t=0,n=0,a=0;if(i){let r=e.x-i.x,o=e.y-i.y;if(r===0&&o===0)return;let s=r*r+o*o,c=Math.sqrt(s);n=r/(c||1),a=o/(c||1),t=Math.min(s*1e4,1)}i={x:e.x,y:e.y},r.push({x:e.x,y:e.y,age:0,force:t,vx:n,vy:a})},update:()=>{o();for(let e=r.length-1;e>=0;e--){let t=r[e],n=t.force*.015625*(1-t.age/64);t.x+=t.vx*n,t.y+=t.vy*n,t.age++,t.age>64&&r.splice(e,1)}for(let e=0;e<r.length;e++)s(r[e]);n.needsUpdate=!0},set radiusScale(e){a=6.4*e},get radiusScale(){return a/6.4},size:64}},_l=(e,t)=>new al(`LiquidEffect`,`
    ...
    `,{uniforms:new Map([[`uTexture`,new ya(e)],[`uStrength`,new ya(t?.strength??.025)],[`uTime`,new ya(0)],[`uFreq`,new ya(t?.freq??4.5)]])}),vl={square:0,circle:1,triangle:2,diamond:3},yl=`
void main() {
  gl_Position = vec4(position, 1.0);
}
`,bl=`
...
`,xl=10,Sl=({variant:e=`square`,pixelSize:t=3,color:n=`#B497CF`,className:r,style:i,antialias:a=!0,patternScale:o=2,patternDensity:s=1,liquid:c=!1,liquidStrength:l=.1,liquidRadius:u=1,pixelSizeJitter:d=0,enableRipples:f=!0,rippleIntensityScale:p=1,rippleThickness:m=.1,rippleSpeed:h=.3,liquidWobbleSpeed:g=4.5,autoPauseOffscreen:_=!0,speed:v=.5,transparent:y=!0,edgeFade:b=.5,noiseAmount:x=0})=>{let S=(0,E.useRef)(null),C=(0,E.useRef)({visible:!0}),w=(0,E.useRef)(v),T=(0,E.useRef)(null),O=(0,E.useRef)(null);return(0,E.useEffect)(()=>{let r=S.current;if(!r)return;w.current=v;let i=[`antialias`,`liquid`,`noiseAmount`],E={antialias:a,liquid:c,noiseAmount:x},D=!1;if(!T.current)D=!0;else if(O.current){for(let e of i)if(O.current[e]!==E[e]){D=!0;break}}if(D){if(T.current){let e=T.current;e.resizeObserver?.disconnect(),cancelAnimationFrame(e.raf),e.quad?.geometry.dispose(),e.material.dispose(),e.composer?.dispose(),e.renderer.dispose(),e.renderer.forceContextLoss(),e.renderer.domElement.parentElement===r&&r.removeChild(e.renderer.domElement),T.current=null}let i=new Rc({canvas:document.createElement(`canvas`),antialias:a,alpha:!0,powerPreference:`high-performance`});i.domElement.style.width=`100%`,i.domElement.style.height=`100%`,i.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),r.appendChild(i.domElement),y?i.setClearAlpha(0):i.setClearColor(0,1);let v={uResolution:{value:new G(0,0)},uTime:{value:0},uColor:{value:new Y(n)},uClickPos:{value:Array.from({length:xl},()=>new G(-1,-1))},uClickTimes:{value:new Float32Array(xl)},uShapeType:{value:vl[e]??0},uPixelSize:{value:t*i.getPixelRatio()},uScale:{value:o},uDensity:{value:s},uPixelJitter:{value:d},uEnableRipples:{value:+!!f},uRippleSpeed:{value:h},uRippleThickness:{value:m},uRippleIntensity:{value:p},uEdgeFade:{value:b}},S=new Vn,E=new na(-1,1,1,-1,0,1),D=new Ai({vertexShader:yl,fragmentShader:bl,uniforms:v,transparent:!0,depthTest:!1,depthWrite:!1,glslVersion:ht}),O=new ii(new xi(2,2),D);S.add(O);let k=performance.now(),A=()=>{let e=r.clientWidth||1,n=r.clientHeight||1;i.setSize(e,n,!1),v.uResolution.value.set(i.domElement.width,i.domElement.height),T.current?.composer&&T.current.composer.setSize(i.domElement.width,i.domElement.height),v.uPixelSize.value=t*i.getPixelRatio()};A();let ee=new ResizeObserver(A);ee.observe(r);let j=(()=>{if(typeof window<`u`&&window.crypto?.getRandomValues){let e=new Uint32Array(1);return window.crypto.getRandomValues(e),e[0]/4294967295}return Math.random()})()*1e3,M,N,P;if(c){N=gl(),N.radiusScale=u,M=new Qc(i);let e=new ol(S,E);P=_l(N.texture,{strength:l,freq:g});let t=new pl(E,P);t.renderToScreen=!0,M.addPass(e),M.addPass(t)}if(x>0){M||(M=new Qc(i),M.addPass(new ol(S,E)));let e=new pl(E,new al(`NoiseEffect`,`uniform float uTime; uniform float uAmount; float hash(vec2 p){ return fract(sin(dot(p, vec2(127.1,311.7))) * 43758.5453);} void mainUv(inout vec2 uv){} void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){ float n=hash(floor(uv*vec2(1920.0,1080.0))+floor(uTime*60.0)); float g=(n-0.5)*uAmount; outputColor=inputColor+vec4(vec3(g),0.0);} `,{uniforms:new Map([[`uTime`,new ya(0)],[`uAmount`,new ya(x)]])}));e.renderToScreen=!0,M&&M.passes.length>0&&M.passes.forEach(e=>e.renderToScreen=!1),M.addPass(e)}M&&M.setSize(i.domElement.width,i.domElement.height);let F=e=>{let t=i.domElement.getBoundingClientRect(),n=i.domElement.width/t.width,r=i.domElement.height/t.height;return{fx:(e.clientX-t.left)*n,fy:(t.height-(e.clientY-t.top))*r,w:i.domElement.width,h:i.domElement.height}};i.domElement.addEventListener(`pointerdown`,e=>{let{fx:t,fy:n}=F(e),r=T.current?.clickIx??0;v.uClickPos.value[r].set(t,n),v.uClickTimes.value[r]=v.uTime.value,T.current&&(T.current.clickIx=(r+1)%xl)},{passive:!0}),i.domElement.addEventListener(`pointermove`,e=>{if(!N)return;let{fx:t,fy:n,w:r,h:i}=F(e);N.addTouch({x:t/r,y:n/i})},{passive:!0});let te=0,ne=()=>{if(_&&!C.current.visible){te=requestAnimationFrame(ne);return}v.uTime.value=j+(performance.now()-k)/1e3*w.current,P&&(P.uniforms.get(`uTime`).value=v.uTime.value),M?(N&&N.update(),M.passes.forEach(e=>{let t=e.effects;t&&t.forEach(e=>{let t=e.uniforms?.get(`uTime`);t&&(t.value=v.uTime.value)})}),M.render()):i.render(S,E),te=requestAnimationFrame(ne)};te=requestAnimationFrame(ne),T.current={renderer:i,scene:S,camera:E,material:D,clickIx:0,uniforms:v,resizeObserver:ee,raf:te,quad:O,timeOffset:j,composer:M,touch:N,liquidEffect:P}}else{let r=T.current;if(r.uniforms.uShapeType.value=vl[e]??0,r.uniforms.uPixelSize.value=t*r.renderer.getPixelRatio(),r.uniforms.uColor.value.set(n),r.uniforms.uScale.value=o,r.uniforms.uDensity.value=s,r.uniforms.uPixelJitter.value=d,r.uniforms.uEnableRipples.value=+!!f,r.uniforms.uRippleIntensity.value=p,r.uniforms.uRippleThickness.value=m,r.uniforms.uRippleSpeed.value=h,r.uniforms.uEdgeFade.value=b,y?r.renderer.setClearAlpha(0):r.renderer.setClearColor(0,1),r.liquidEffect){let e=r.liquidEffect;e&&(e.value=l);let t=r.liquidEffect.uniforms.get(`uFreq`);t&&(t.value=g)}r.touch&&(r.touch.radiusScale=u)}return O.current=E,()=>{if(T.current&&D||!T.current)return;let e=T.current;e.resizeObserver?.disconnect(),cancelAnimationFrame(e.raf),e.quad?.geometry.dispose(),e.material.dispose(),e.composer?.dispose(),e.renderer.dispose(),e.renderer.forceContextLoss(),e.renderer.domElement.parentElement===r&&r.removeChild(e.renderer.domElement),T.current=null}},[a,c,x,t,o,s,f,p,m,h,d,b,y,l,u,g,_,e,n,v]),(0,D.jsx)(`div`,{ref:S,className:`pixel-blast-container ${r??``}`,style:i,"aria-label":`PixelBlast interactive background`})};function Cl(){return(0,D.jsx)(`section`,{id:`topo`,className:`relative overflow-hidden pt-28 sm:pt-26`,children:(0,D.jsxs)(`div`,{className:`mx-auto max-w-[1400px] px-5 sm:px-8`,children:[(0,D.jsxs)(`div`,{className:`relative overflow-hidden rounded-md border border-border px-6 py-20 text-center sm:px-12 sm:py-28`,children:[(0,D.jsx)(`div`,{className:`pointer-events-none absolute inset-0 z-0`,"aria-hidden":`true`,children:(0,D.jsx)(Sl,{variant:`circle`,pixelSize:5,color:`#B497CF`,patternScale:2.25,patternDensity:.55,pixelSizeJitter:.7,enableRipples:!0,rippleSpeed:.4,rippleThickness:.12,rippleIntensityScale:1.5,liquid:!0,liquidStrength:.12,liquidRadius:1.2,liquidWobbleSpeed:5,speed:.35,edgeFade:.5,transparent:!0})}),(0,D.jsxs)(`div`,{className:`relative z-10`,children:[(0,D.jsx)(O,{children:(0,D.jsxs)(`span`,{className:`inline-flex items-center gap-2 rounded-full border border-border bg-background/40 px-4 py-1.5 text-xs font-medium text-muted-foreground backdrop-blur`,children:[(0,D.jsx)(`span`,{className:`size-2 rounded-full bg-primary`,"aria-hidden":`true`}),i.availability]})}),(0,D.jsx)(O,{delay:80,children:(0,D.jsx)(`h1`,{className:`mx-auto mt-8 max-w-4xl text-4xl font-medium leading-[1.05] sm:text-6xl lg:text-7xl`,children:i.name})}),(0,D.jsx)(O,{delay:160,children:(0,D.jsx)(`p`,{className:`mx-auto mt-5 max-w-2xl text-base text-white sm:text-lg`,children:i.role})}),(0,D.jsx)(O,{delay:240,children:(0,D.jsxs)(`div`,{className:`mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row`,children:[(0,D.jsxs)(`a`,{href:`#contato`,className:`inline-flex w-full items-center justify-center gap-2 rounded-full bg-primary px-7 py-3.5 text-sm font-semibold text-primary-foreground transition-transform hover:scale-[1.03] sm:w-auto`,children:[`Entre em contato`,(0,D.jsx)(h,{className:`size-4`,"aria-hidden":`true`})]}),(0,D.jsx)(`a`,{href:`#skills`,className:`inline-flex w-full items-center justify-center rounded-full border border-border bg-background/40 px-7 py-3.5 text-sm font-semibold backdrop-blur transition-colors hover:bg-secondary sm:w-auto`,children:`Ver skills`})]})})]})]}),(0,D.jsxs)(`div`,{className:`mt-6 grid gap-8 lg:grid-cols-2 lg:items-center`,children:[(0,D.jsx)(O,{children:(0,D.jsx)(`div`,{children:(0,D.jsx)(`h2`,{className:`text-3xl text-center font-high leading-tight sm:text-4xl lg:text-5xl`,children:`Resultados que comprovam a entrega`})})}),(0,D.jsx)(`div`,{className:`grid grid-cols-2 gap-1 sm:gap-3`,children:s.map((e,t)=>(0,D.jsx)(O,{delay:t*70,children:(0,D.jsxs)(`div`,{className:`stat-card h-full rounded-md border border-border px-5 py-6 sm:px-6 sm:py-7`,children:[(0,D.jsx)(`p`,{className:`font-display text-3xl font-semibold text-foreground sm:text-4xl lg:text-5xl`,children:e.value}),(0,D.jsx)(`p`,{className:`mt-2 text-xs text-muted-foreground sm:text-sm`,children:e.label})]})},e.label))})]})]})})}function wl(){return(0,D.jsx)(`section`,{id:`sobre`,className:`py-24 sm:py-15`,children:(0,D.jsxs)(`div`,{className:`mx-auto grid max-w-[1200px] gap-12 px-5 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-20`,children:[(0,D.jsx)(O,{children:(0,D.jsxs)(`div`,{children:[(0,D.jsx)(`p`,{className:`text-sm font-medium uppercase tracking-[0.2em] text-muted-foreground`,children:`Sobre`}),(0,D.jsx)(`h2`,{className:`mt-4 text-3xl font-medium leading-tight sm:text-5xl`,children:`Infraestrutura confiável, do hardware à nuvem.`})]})}),(0,D.jsx)(O,{delay:120,children:(0,D.jsx)(`p`,{className:`text-base leading-relaxed text-muted-foreground sm:text-lg`,children:i.intro})})]})})}function Tl(){return(0,D.jsx)(`section`,{id:`skills`,className:`py-24 sm:py-12`,children:(0,D.jsxs)(`div`,{className:`mx-auto max-w-[1200px] px-5 sm:px-8`,children:[(0,D.jsx)(O,{children:(0,D.jsxs)(`div`,{className:`max-w-2xl`,children:[(0,D.jsx)(`p`,{className:`text-sm font-medium uppercase tracking-[0.2em] text-muted-foreground`,children:`Skills`}),(0,D.jsx)(`h2`,{className:`mt-4 text-3xl font-medium leading-tight sm:text-5xl`,children:`Tecnologias e ferramentas`}),(0,D.jsx)(`p`,{className:`mt-4 text-base text-muted-foreground sm:text-lg`,children:`Tecnologias e ferramentas que domino para entregar soluções robustas e escaláveis.`})]})}),(0,D.jsx)(`div`,{className:`mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3`,children:o.map((e,t)=>(0,D.jsx)(O,{delay:t*70,children:(0,D.jsxs)(`article`,{className:`card-surface rounded-md h-full p-6`,children:[(0,D.jsx)(`h3`,{className:`font-display text-lg font-semibold`,children:e.title}),(0,D.jsx)(`ul`,{className:`mt-5 flex flex-wrap gap-2`,children:e.items.map(e=>(0,D.jsx)(`li`,{className:`rounded-full border border-border bg-secondary px-3 py-1.5 text-xs text-muted-foreground`,children:e},e))})]})},e.title))})]})})}var El={network:S,shield:w,server:f,cloud:v,automation:T,monitor:m};function Dl(){return(0,D.jsx)(`section`,{id:`competencias`,className:`py-24 sm:py-5`,children:(0,D.jsxs)(`div`,{className:`mx-auto max-w-[1200px] px-5 sm:px-8`,children:[(0,D.jsx)(O,{children:(0,D.jsxs)(`div`,{className:`max-w-2xl`,children:[(0,D.jsx)(`p`,{className:`text-sm font-medium uppercase tracking-[0.2em] text-muted-foreground`,children:`Competências`}),(0,D.jsx)(`h2`,{className:`mt-4 text-3xl font-medium leading-tight sm:text-5xl`,children:`Áreas de expertise`}),(0,D.jsx)(`p`,{className:`mt-4 text-base text-muted-foreground sm:text-lg`,children:`Áreas de expertise desenvolvidas ao longo da carreira para entregar soluções completas.`})]})}),(0,D.jsx)(`div`,{className:`mt-14 grid gap-3 sm:grid-cols-2 lg:grid-cols-3`,children:c.map((e,t)=>{let n=El[e.icon];return(0,D.jsx)(O,{delay:t*60,children:(0,D.jsxs)(`article`,{className:`card-surface rounded-md h-full p-6`,children:[(0,D.jsx)(`span`,{className:`grid size-11 place-items-center rounded-md bg-primary/15 text-primary`,children:(0,D.jsx)(n,{className:`size-5`,"aria-hidden":`true`})}),(0,D.jsx)(`h3`,{className:`mt-5 font-display text-lg font-semibold`,children:e.title}),(0,D.jsx)(`p`,{className:`mt-3 text-sm leading-relaxed text-muted-foreground`,children:e.description})]})},e.title)})}),(0,D.jsx)(O,{delay:100,children:(0,D.jsx)(`div`,{className:`aurora mt-6 rounded-md border border-border p-8 sm:p-12`,children:(0,D.jsxs)(`div`,{children:[(0,D.jsx)(`h3`,{className:`text-2xl font-medium sm:text-3xl`,children:`Por que me escolher?`}),(0,D.jsx)(`ul`,{className:`mt-7 grid gap-3 sm:grid-cols-2`,children:e.map(e=>(0,D.jsxs)(`li`,{className:`flex items-start gap-3 text-sm text-muted-foreground`,children:[(0,D.jsx)(_,{className:`mt-0.5 size-4 shrink-0 text-primary`,"aria-hidden":`true`}),e]},e))})]})})})]})})}var Ol={phone:C,mail:x,linkedin:b,github:y};function kl(){return(0,D.jsx)(`section`,{id:`contato`,className:`py-24 sm:py-32`,children:(0,D.jsxs)(`div`,{className:`mx-auto max-w-[1200px] px-5 sm:px-8`,children:[(0,D.jsx)(O,{children:(0,D.jsxs)(`div`,{className:`max-w-2xl`,children:[(0,D.jsx)(`p`,{className:`text-sm font-medium uppercase tracking-[0.2em] text-muted-foreground`,children:`Contato`}),(0,D.jsx)(`h2`,{className:`mt-4 text-3xl font-medium leading-tight sm:text-5xl`,children:`Vamos conversar?`}),(0,D.jsx)(`p`,{className:`mt-4 text-base text-muted-foreground sm:text-lg`,children:`Estou disponível para novos projetos e oportunidades. Entre em contato pelos canais abaixo.`})]})}),(0,D.jsxs)(`div`,{className:`mt-14 grid gap-6 lg:grid-cols-[1.15fr_0.85fr]`,children:[(0,D.jsx)(`div`,{className:`grid gap-4 sm:grid-cols-2`,children:a.map((e,t)=>{let n=Ol[e.icon];return(0,D.jsx)(O,{delay:t*60,children:(0,D.jsxs)(`a`,{href:e.href,target:e.href.startsWith(`http`)?`_blank`:void 0,rel:`noreferrer`,className:`card-surface flex h-full rounded-md items-center gap-4 p-6`,children:[(0,D.jsx)(`span`,{className:`grid size-11 shrink-0 place-items-center rounded-md bg-primary/15 text-primary`,children:(0,D.jsx)(n,{className:`size-6`,"aria-hidden":`true`})}),(0,D.jsxs)(`span`,{className:`min-w-0`,children:[(0,D.jsx)(`span`,{className:`block text-xs uppercase tracking-widest text-muted-foreground`,children:e.label}),(0,D.jsx)(`span`,{className:`mt-1 block truncate text-sm font-medium`,children:e.value})]}),(0,D.jsx)(g,{className:`ml-auto size-4 shrink-0 text-muted-foreground`,"aria-hidden":`true`})]})},e.label)})}),(0,D.jsx)(O,{delay:120,children:(0,D.jsxs)(`div`,{className:`aurora flex h-full flex-col justify-between gap-8 rounded-md border border-border p-8`,children:[(0,D.jsxs)(`div`,{children:[(0,D.jsx)(`h3`,{className:`font-display text-xl font-semibold`,children:`Achou interessante?`}),(0,D.jsx)(`p`,{className:`mt-3 text-sm leading-relaxed text-muted-foreground`,children:`Para uma visão abrangente das minhas habilidades e experiências, sinta-se à entrar em contato.`})]}),(0,D.jsx)(`div`,{className:`flex flex-col gap-3`,children:(0,D.jsx)(`a`,{href:t,target:`_blank`,rel:`noreferrer`,className:`inline-flex items-center justify-center rounded-full border border-border bg-background/40 px-6 py-3 text-sm font-semibold backdrop-blur transition-colors hover:bg-secondary`,children:`Falar no WhatsApp`})})]})})]})]})})}function Al(){return(0,D.jsxs)(`div`,{className:`min-h-screen bg-background`,children:[(0,D.jsx)(d,{}),(0,D.jsxs)(`main`,{children:[(0,D.jsx)(Cl,{}),(0,D.jsx)(wl,{}),(0,D.jsx)(Tl,{}),(0,D.jsx)(Dl,{}),(0,D.jsx)(kl,{})]}),(0,D.jsx)(p,{})]})}export{Al as component};