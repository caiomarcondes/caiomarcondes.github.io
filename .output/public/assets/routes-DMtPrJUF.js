...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qa(e,t,n){let r=new Float32Array(Na),i=new K(0,1,0);return new Oi({name:`SphericalGaussianBlur`,defines:{n:Na,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Xa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ja(){return new Oi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Xa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ya(){return new Oi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xa(),fragmentShader:`
	...
	`}var Za=class extends $t{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new mi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
#endif
#include <dithering_fragment>
}`,ol=`uniform vec2 resolution;uniform vec2 texelSize;uniform float cameraNear;uniform float cameraFar;uniform float aspect;uniform float time;varying vec2 vUv;VERTEX_HEAD void main(){vUv=position.xy*0.5+0.5;VERTEX_MAIN_SUPPORT gl_Position=vec4(position.xy,1.0,1.0);}`,sl=class extends Oi{constructor(e,t,n,r,i=!1){super({name:`EffectMaterial`,defines:{THREE_REVISION:`185`.replace(/\D+/g,``),DEPTH_PACKING:`0`,ENCODE_OUTPUT:`1`},uniforms:{inputBuffer:new _a(null),depthBuffer:new _a(null),resolution:new _a(new G),texelSize:new _a(new G),cameraNear:new _a(.3),cameraFar:new _a(1e3),aspect:new _a(1),time:new _a(0)},blending:0,toneMapped:!1,depthWrite:!1,depthTest:!1,dithering:i}),e&&this.setShaderParts(e),t&&this.setDefines(t),n&&this.setUniforms(n),this.copyCameraSettings(r)}set inputBuffer(e){this.uniforms.inputBuffer.value=e}setInputBuffer(e){this.uniforms.inputBuffer.value=e}get depthBuffer(){return this.uniforms.depthBuffer.value}set depthBuffer(e){this.uniforms.depthBuffer.value=e}get depthPacking(){return Number(this.defines.DEPTH_PACKING)}set depthPacking(e){this.defines.DEPTH_PACKING=e.toFixed(0),this.needsUpdate=!0}setDepthBuffer(e,t=ot){this.depthBuffer=e,this.depthPacking=t}setShaderData(e){this.setShaderParts(e.shaderParts),this.setDefines(e.defines),this.setUniforms(e.uniforms),this.setExtensions(e.extensions)}setShaderParts(e){return this.fragmentShader=al.replace(Q.FRAGMENT_HEAD,e.get(Q.FRAGMENT_HEAD)||``).replace(Q.FRAGMENT_MAIN_UV,e.get(Q.FRAGMENT_MAIN_UV)||``).replace(Q.FRAGMENT_MAIN_IMAGE,e.get(Q.FRAGMENT_MAIN_IMAGE)||``),this.vertexShader=ol.replace(Q.VERTEX_HEAD,e.get(Q.VERTEX_HEAD)||``).replace(Q.VERTEX_MAIN_SUPPORT,e.get(Q.VERTEX_MAIN_SUPPORT)||``),this.needsUpdate=!0,this}setDefines(e){for(let t of e.entries())this.defines[t[0]]=t[1];return this.needsUpdate=!0,this}setUniforms(e){for(let t of e.entries())this.uniforms[t[0]]=t[1];return this}setExtensions(e){this.extensions={};for(let t of e)this.extensions[t]=!0;return this}get encodeOutput(){return this.defines.ENCODE_OUTPUT!==void 0}set encodeOutput(e){this.encodeOutput!==e&&(e?this.defines.ENCODE_OUTPUT=`1`:delete this.defines.ENCODE_OUTPUT,this.needsUpdate=!0)}isOutputEncodingEnabled(e){return this.encodeOutput}setOutputEncodingEnabled(e){this.encodeOutput=e}get time(){return this.uniforms.time.value}set time(e){this.uniforms.time.value=e}setDeltaTime(e){this.uniforms.time.value+=e}adoptCameraSettings(e){this.copyCameraSettings(e)}copyCameraSettings(e){e&&(this.uniforms.cameraNear.value=e.near,this.uniforms.cameraFar.value=e.far,e instanceof $i?this.defines.PERSPECTIVE_CAMERA=`1`:delete this.defines.PERSPECTIVE_CAMERA,this.needsUpdate=!0)}setSize(e,t){let n=this.uniforms;n.resolution.value.set(e,t),n.texelSize.value.set(1/e,1/t),n.aspect.value=e/t}static get Section(){return Q}};Number(`185`.replace(/\D+/g,``));var cl=255/256;new Float32Array([cl/256**3,cl/256**2,cl/256,cl]),new Float32Array([cl,cl/256,cl/256**2,1/256**3]);function ll(e,t,n){for(let r of t){let t=`$1`+e+r.charAt(0).toUpperCase()+r.slice(1),i=RegExp(`([^\\.])(\\b`+r+`\\b)`,`g`);for(let e of n.entries())e[1]!==null&&n.set(e[0],e[1].replace(i,t))}}function ul(e,t,n){let r=t.getFragmentShader(),i=t.getVertexShader(),a=r!==void 0&&/mainImage/.test(r),o=r!==void 0&&/mainUv/.test(r);if(n.attributes|=t.getAttributes(),r===void 0)throw Error(`Missing fragment shader (${t.name})`);if(o&&(n.attributes&Zc.CONVOLUTION)!==0)throw Error(`Effects that transform UVs are incompatible with convolution effects (${t.name})`);if(!a&&!o)throw Error(`Could not find mainImage or mainUv function (${t.name})`);{let s=/\w+\s+(\w+)\([\w\s,]*\)\s*{/g,c=n.shaderParts,l=c.get(Q.FRAGMENT_HEAD)||``,u=c.get(Q.FRAGMENT_MAIN_UV)||``,d=c.get(Q.FRAGMENT_MAIN_IMAGE)||``,f=c.get(Q.VERTEX_HEAD)||``,p=c.get(Q.VERTEX_MAIN_SUPPORT)||``,m=new Set,h=new Set;if(o&&(u+=`	${e}MainUv(UV);
`,n.uvTransformation=!0),i!==null&&/mainSupport/.test(i)){let t=/mainSupport *\([\w\s]*?uv\s*?\)/.test(i);p+=`	${e}MainSupport(`,p+=t?`vUv);
`:`);
`;for(let e of i.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))for(let t of e[1].split(/\s*,\s*/))n.varyings.add(t),m.add(t),h.add(t);for(let e of i.matchAll(s))h.add(e[1])}for(let e of r.matchAll(s))h.add(e[1]);for(let e of t.defines.keys())h.add(e.replace(/\([\w\s,]*\)/g,``));for(let e of t.uniforms.keys())h.add(e);h.delete(`while`),h.delete(`for`),h.delete(`if`),t.uniforms.forEach((t,r)=>n.uniforms.set(e+r.charAt(0).toUpperCase()+r.slice(1),t)),t.defines.forEach((t,r)=>n.defines.set(e+r.charAt(0).toUpperCase()+r.slice(1),t));let g=new Map([[`fragment`,r],[`vertex`,i]]);ll(e,h,n.defines),ll(e,h,g),r=g.get(`fragment`),i=g.get(`vertex`);let _=t.blendMode;if(n.blendModes.set(_.blendFunction,_),a){t.inputColorSpace!==null&&t.inputColorSpace!==n.colorSpace&&(d+=t.inputColorSpace===`srgb`?`color0 = sRGBTransferOETF(color0);
	`:`color0 = sRGBToLinear(color0);
	`),t.outputColorSpace===``?t.inputColorSpace!==null&&(n.colorSpace=t.inputColorSpace):n.colorSpace=t.outputColorSpace,d+=`${e}MainImage(color0, UV, `,(n.attributes&Zc.DEPTH)!==0&&/MainImage *\([\w\s,]*?depth[\w\s,]*?\)/.test(r)&&(d+=`depth, `,n.readDepth=!0),d+=`color1);
...
#`));this.skipRendering=t===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(e)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(e,t=ot){this.fullscreenMaterial.depthBuffer=e,this.fullscreenMaterial.depthPacking=t;for(let n of this.effects)n.setDepthTexture(e,t)}render(e,t,n,r,i){for(let n of this.effects)n.update(e,t,r);if(!this.skipRendering||this.renderToScreen){let i=this.fullscreenMaterial;i.inputBuffer=t.texture,i.time+=r*this.timeScale,e.setRenderTarget(this.renderToScreen?null:n),e.render(this.scene,this.camera)}}setSize(e,t){this.fullscreenMaterial.setSize(e,t);for(let n of this.effects)n.setSize(e,t)}initialize(e,t,n){this.renderer=e;for(let r of this.effects)r.initialize(e,t,n);this.updateMaterial(),n!==void 0&&n!==1009&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`)}dispose(){super.dispose();for(let e of this.effects)e.removeEventListener(`change`,this.listener),e.dispose()}handleEvent(e){e.type===`change`&&this.recompile()}};new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,0,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([1,0,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([0,1,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([0,1,1]),new Float32Array([1,1,1]),new Float32Array([0,-.25,.25,-.125,.125,-.375,.375]),new Float32Array([0,0]),new Float32Array([.25,-.25]),new Float32Array([-.25,.25]),new Float32Array([.125,-.125]),new Float32Array([-.125,.125]),new Uint8Array([0,0]),new Uint8Array([3,0]),new Uint8Array([0,3]),new Uint8Array([3,3]),new Uint8Array([1,0]),new Uint8Array([4,0]),new Uint8Array([1,3]),new Uint8Array([4,3]),new Uint8Array([0,1]),new Uint8Array([3,1]),new Uint8Array([0,4]),new Uint8Array([3,4]),new Uint8Array([1,1]),new Uint8Array([4,1]),new Uint8Array([1,4]),new Uint8Array([4,4]),new Uint8Array([0,0]),new Uint8Array([1,0]),new Uint8Array([0,2]),new Uint8Array([1,2]),new Uint8Array([2,0]),new Uint8Array([3,0]),new Uint8Array([2,2]),new Uint8Array([3,2]),new Uint8Array([0,1]),new Uint8Array([1,1]),new Uint8Array([0,3]),new Uint8Array([1,3]),new Uint8Array([2,1]),new Uint8Array([3,1]),new Uint8Array([2,3]),new Uint8Array([3,3]),pl(0,0,0,0),new Float32Array([0,0,0,0]),pl(0,0,0,1),new Float32Array([0,0,0,1]),pl(0,0,1,0),new Float32Array([0,0,1,0]),pl(0,0,1,1),new Float32Array([0,0,1,1]),pl(0,1,0,0),new Float32Array([0,1,0,0]),pl(0,1,0,1),new Float32Array([0,1,0,1]),pl(0,1,1,0),new Float32Array([0,1,1,0]),pl(0,1,1,1),new Float32Array([0,1,1,1]),pl(1,0,0,0),new Float32Array([1,0,0,0]),pl(1,0,0,1),new Float32Array([1,0,0,1]),pl(1,0,1,0),new Float32Array([1,0,1,0]),pl(1,0,1,1),new Float32Array([1,0,1,1]),pl(1,1,0,0),new Float32Array([1,1,0,0]),pl(1,1,0,1),new Float32Array([1,1,0,1]),pl(1,1,1,0),new Float32Array([1,1,1,0]),pl(1,1,1,1),new Float32Array([1,1,1,1]);function fl(e,t,n){return e+(t-e)*n}function pl(e,t,n,r){return fl(fl(e,t,.75),fl(n,r,.75),.875)}var ml=()=>{let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`);if(!t)throw Error(`2D context not available`);t.fillStyle=`black`,t.fillRect(0,0,e.width,e.height);let n=new Xt(e);n.minFilter=j,n.magFilter=j,n.generateMipmaps=!1;let r=[],i=null,a=6.4,o=()=>{t.fillStyle=`black`,t.fillRect(0,0,e.width,e.height)},s=e=>{let n={x:e.x*64,y:(1-e.y)*64},r=1;r=e.age<19.2?(e=>Math.sin(e*Math.PI/2))(e.age/19.2):(e=>-e*(e-2))(1-(e.age-19.2)/44.8)||0,r*=e.force;let i=`${(e.vx+1)/2*255}, ${(e.vy+1)/2*255}, ${r*255}`;t.shadowOffsetX=320,t.shadowOffsetY=320,t.shadowBlur=a,t.shadowColor=`rgba(${i},${.22*r})`,t.beginPath(),t.fillStyle=`rgba(255,0,0,1)`,t.arc(n.x-320,n.y-320,a,0,Math.PI*2),t.fill()};return{canvas:e,texture:n,addTouch:e=>{let t=0,n=0,a=0;if(i){let r=e.x-i.x,o=e.y-i.y;if(r===0&&o===0)return;let s=r*r+o*o,c=Math.sqrt(s);n=r/(c||1),a=o/(c||1),t=Math.min(s*1e4,1)}i={x:e.x,y:e.y},r.push({x:e.x,y:e.y,age:0,force:t,vx:n,vy:a})},update:()=>{o();for(let e=r.length-1;e>=0;e--){let t=r[e],n=t.force*.015625*(1-t.age/64);t.x+=t.vx*n,t.y+=t.vy*n,t.age++,t.age>64&&r.splice(e,1)}for(let e=0;e<r.length;e++)s(r[e]);n.needsUpdate=!0},set radiusScale(e){a=6.4*e},get radiusScale(){return a/6.4},size:64}},hl=(e,t)=>new rl(`LiquidEffect`,`
    ...
    `,{uniforms:new Map([[`uTexture`,new _a(e)],[`uStrength`,new _a(t?.strength??.025)],[`uTime`,new _a(0)],[`uFreq`,new _a(t?.freq??4.5)]])}),gl={square:0,circle:1,triangle:2,diamond:3},_l=`
void main() {
  gl_Position = vec4(position, 1.0);
}
`,vl=`
...
`,yl=10,bl=({variant:e=`square`,pixelSize:t=3,color:n=`#B497CF`,className:r,style:i,antialias:a=!0,patternScale:o=2,patternDensity:s=1,liquid:c=!1,liquidStrength:l=.1,liquidRadius:u=1,pixelSizeJitter:d=0,enableRipples:f=!0,rippleIntensityScale:p=1,rippleThickness:m=.1,rippleSpeed:h=.3,liquidWobbleSpeed:g=4.5,autoPauseOffscreen:_=!0,speed:v=.5,transparent:y=!0,edgeFade:b=.5,noiseAmount:x=0})=>{let S=(0,w.useRef)(null),C=(0,w.useRef)({visible:!0}),E=(0,w.useRef)(v),D=(0,w.useRef)(null),O=(0,w.useRef)(null);return(0,w.useEffect)(()=>{let r=S.current;if(!r)return;E.current=v;let i=[`antialias`,`liquid`,`noiseAmount`],w={antialias:a,liquid:c,noiseAmount:x},T=!1;if(!D.current)T=!0;else if(O.current){for(let e of i)if(O.current[e]!==w[e]){T=!0;break}}if(T){if(D.current){let e=D.current;e.resizeObserver?.disconnect(),cancelAnimationFrame(e.raf),e.quad?.geometry.dispose(),e.material.dispose(),e.composer?.dispose(),e.renderer.dispose(),e.renderer.forceContextLoss(),e.renderer.domElement.parentElement===r&&r.removeChild(e.renderer.domElement),D.current=null}let i=new Ic({canvas:document.createElement(`canvas`),antialias:a,alpha:!0,powerPreference:`high-performance`});i.domElement.style.width=`100%`,i.domElement.style.height=`100%`,i.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),r.appendChild(i.domElement),y?i.setClearAlpha(0):i.setClearColor(0,1);let v={uResolution:{value:new G(0,0)},uTime:{value:0},uColor:{value:new Y(n)},uClickPos:{value:Array.from({length:yl},()=>new G(-1,-1))},uClickTimes:{value:new Float32Array(yl)},uShapeType:{value:gl[e]??0},uPixelSize:{value:t*i.getPixelRatio()},uScale:{value:o},uDensity:{value:s},uPixelJitter:{value:d},uEnableRipples:{value:+!!f},uRippleSpeed:{value:h},uRippleThickness:{value:m},uRippleIntensity:{value:p},uEdgeFade:{value:b}},S=new zn,w=new ea(-1,1,1,-1,0,1),T=new Oi({vertexShader:_l,fragmentShader:vl,uniforms:v,transparent:!0,depthTest:!1,depthWrite:!1,glslVersion:pt}),O=new ni(new yi(2,2),T);S.add(O);let k=performance.now(),A=()=>{let e=r.clientWidth||1,n=r.clientHeight||1;i.setSize(e,n,!1),v.uResolution.value.set(i.domElement.width,i.domElement.height),D.current?.composer&&D.current.composer.setSize(i.domElement.width,i.domElement.height),v.uPixelSize.value=t*i.getPixelRatio()};A();let ee=new ResizeObserver(A);ee.observe(r);let te=(()=>{if(typeof window<`u`&&window.crypto?.getRandomValues){let e=new Uint32Array(1);return window.crypto.getRandomValues(e),e[0]/4294967295}return Math.random()})()*1e3,j,M,ne;if(c){M=ml(),M.radiusScale=u,j=new Xc(i);let e=new il(S,w);ne=hl(M.texture,{strength:l,freq:g});let t=new dl(w,ne);t.renderToScreen=!0,j.addPass(e),j.addPass(t)}if(x>0){j||(j=new Xc(i),j.addPass(new il(S,w)));let e=new dl(w,new rl(`NoiseEffect`,`uniform float uTime; uniform float uAmount; float hash(vec2 p){ return fract(sin(dot(p, vec2(127.1,311.7))) * 43758.5453);} void mainUv(inout vec2 uv){} void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){ float n=hash(floor(uv*vec2(1920.0,1080.0))+floor(uTime*60.0)); float g=(n-0.5)*uAmount; outputColor=inputColor+vec4(vec3(g),0.0);} `,{uniforms:new Map([[`uTime`,new _a(0)],[`uAmount`,new _a(x)]])}));e.renderToScreen=!0,j&&j.passes.length>0&&j.passes.forEach(e=>e.renderToScreen=!1),j.addPass(e)}j&&j.setSize(i.domElement.width,i.domElement.height);let N=e=>{let t=i.domElement.getBoundingClientRect(),n=i.domElement.width/t.width,r=i.domElement.height/t.height;return{fx:(e.clientX-t.left)*n,fy:(t.height-(e.clientY-t.top))*r,w:i.domElement.width,h:i.domElement.height}};i.domElement.addEventListener(`pointerdown`,e=>{let{fx:t,fy:n}=N(e),r=D.current?.clickIx??0;v.uClickPos.value[r].set(t,n),v.uClickTimes.value[r]=v.uTime.value,D.current&&(D.current.clickIx=(r+1)%yl)},{passive:!0}),i.domElement.addEventListener(`pointermove`,e=>{if(!M)return;let{fx:t,fy:n,w:r,h:i}=N(e);M.addTouch({x:t/r,y:n/i})},{passive:!0});let P=0,re=()=>{if(_&&!C.current.visible){P=requestAnimationFrame(re);return}v.uTime.value=te+(performance.now()-k)/1e3*E.current,ne&&(ne.uniforms.get(`uTime`).value=v.uTime.value),j?(M&&M.update(),j.passes.forEach(e=>{let t=e.effects;t&&t.forEach(e=>{let t=e.uniforms?.get(`uTime`);t&&(t.value=v.uTime.value)})}),j.render()):i.render(S,w),P=requestAnimationFrame(re)};P=requestAnimationFrame(re),D.current={renderer:i,scene:S,camera:w,material:T,clickIx:0,uniforms:v,resizeObserver:ee,raf:P,quad:O,timeOffset:te,composer:j,touch:M,liquidEffect:ne}}else{let r=D.current;if(r.uniforms.uShapeType.value=gl[e]??0,r.uniforms.uPixelSize.value=t*r.renderer.getPixelRatio(),r.uniforms.uColor.value.set(n),r.uniforms.uScale.value=o,r.uniforms.uDensity.value=s,r.uniforms.uPixelJitter.value=d,r.uniforms.uEnableRipples.value=+!!f,r.uniforms.uRippleIntensity.value=p,r.uniforms.uRippleThickness.value=m,r.uniforms.uRippleSpeed.value=h,r.uniforms.uEdgeFade.value=b,y?r.renderer.setClearAlpha(0):r.renderer.setClearColor(0,1),r.liquidEffect){let e=r.liquidEffect;e&&(e.value=l);let t=r.liquidEffect.uniforms.get(`uFreq`);t&&(t.value=g)}r.touch&&(r.touch.radiusScale=u)}return O.current=w,()=>{if(D.current&&T||!D.current)return;let e=D.current;e.resizeObserver?.disconnect(),cancelAnimationFrame(e.raf),e.quad?.geometry.dispose(),e.material.dispose(),e.composer?.dispose(),e.renderer.dispose(),e.renderer.forceContextLoss(),e.renderer.domElement.parentElement===r&&r.removeChild(e.renderer.domElement),D.current=null}},[a,c,x,t,o,s,f,p,m,h,d,b,y,l,u,g,_,e,n,v]),(0,T.jsx)(`div`,{ref:S,className:`pixel-blast-container ${r??``}`,style:i,"aria-label":`PixelBlast interactive background`})};function xl(){let{t:e}=s();return(0,T.jsx)(`section`,{id:`topo`,className:`relative overflow-hidden pt-28 sm:pt-26`,children:(0,T.jsxs)(`div`,{className:`mx-auto max-w-[1400px] px-5 sm:px-8`,children:[(0,T.jsxs)(`div`,{className:`relative overflow-hidden rounded-md border border-border px-6 py-20 text-center sm:px-12 sm:py-28`,children:[(0,T.jsx)(`div`,{className:`pointer-events-none absolute inset-0 z-0`,"aria-hidden":`true`,children:(0,T.jsx)(bl,{variant:`circle`,pixelSize:5,color:`#B497CF`,patternScale:2.25,patternDensity:.55,pixelSizeJitter:.7,enableRipples:!0,rippleSpeed:.4,rippleThickness:.12,rippleIntensityScale:1.5,liquid:!0,liquidStrength:.12,liquidRadius:1.2,liquidWobbleSpeed:5,speed:.35,edgeFade:.5,transparent:!0})}),(0,T.jsxs)(`div`,{className:`relative z-10`,children:[(0,T.jsx)(E,{children:(0,T.jsxs)(`span`,{className:`inline-flex items-center gap-2 rounded-full border border-border bg-background/40 px-4 py-1.5 text-xs font-medium text-muted-foreground backdrop-blur`,children:[(0,T.jsx)(`span`,{className:`size-2 rounded-full bg-primary`,"aria-hidden":`true`}),e(`hero.availability`)]})}),(0,T.jsx)(E,{delay:80,children:(0,T.jsx)(`h1`,{className:`mx-auto mt-8 max-w-4xl text-4xl font-medium leading-[1.05] sm:text-6xl lg:text-7xl`,children:n.name})}),(0,T.jsx)(E,{delay:160,children:(0,T.jsx)(`p`,{className:`mx-auto mt-5 max-w-2xl text-base text-white sm:text-lg`,children:e(`profile.role`)})}),(0,T.jsx)(E,{delay:240,children:(0,T.jsxs)(`div`,{className:`mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row`,children:[(0,T.jsxs)(`a`,{href:`#contato`,className:`inline-flex w-full items-center justify-center gap-2 rounded-full bg-primary px-7 py-3.5 text-sm font-semibold text-primary-foreground transition-transform hover:scale-[1.03] sm:w-auto`,children:[e(`header.contact`),(0,T.jsx)(p,{className:`size-4`,"aria-hidden":`true`})]}),(0,T.jsx)(`a`,{href:`#skills`,className:`inline-flex w-full items-center justify-center rounded-full border border-border bg-background/40 px-7 py-3.5 text-sm font-semibold backdrop-blur transition-colors hover:bg-secondary sm:w-auto`,children:e(`skills.title`)})]})})]})]}),(0,T.jsxs)(`div`,{className:`mt-6 grid gap-8 lg:grid-cols-2 lg:items-center`,children:[(0,T.jsx)(E,{children:(0,T.jsx)(`div`,{children:(0,T.jsx)(`h2`,{className:`text-3xl text-center font-high leading-tight sm:text-4xl lg:text-5xl`,children:e(`hero.resultsTitle`)})})}),(0,T.jsx)(`div`,{className:`grid grid-cols-2 gap-1 sm:gap-3`,children:Object.entries({experience:e(`stats.experience`),projects:e(`stats.projects`),uptime:e(`stats.uptime`),support:e(`stats.support`)}).map(([e,t],n)=>(0,T.jsx)(E,{delay:n*70,children:(0,T.jsxs)(`div`,{className:`stat-card h-full rounded-md border border-border px-5 py-6 sm:px-6 sm:py-7`,children:[(0,T.jsx)(`p`,{className:`font-display text-3xl font-semibold text-foreground sm:text-4xl lg:text-5xl`,children:[`+7`,`+50`,`99%`,`24/7`][n]}),(0,T.jsx)(`p`,{className:`mt-2 text-xs text-muted-foreground sm:text-sm`,children:t})]})},e))})]})]})})}function Sl(){let{t:e}=s();return(0,T.jsx)(`section`,{id:`sobre`,className:`py-24 sm:py-15`,children:(0,T.jsxs)(`div`,{className:`mx-auto grid max-w-[1200px] gap-12 px-5 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-20`,children:[(0,T.jsx)(E,{children:(0,T.jsxs)(`div`,{children:[(0,T.jsx)(`p`,{className:`text-sm font-medium uppercase tracking-[0.2em] text-muted-foreground`,children:e(`about.label`)}),(0,T.jsx)(`h2`,{className:`mt-4 text-3xl font-medium leading-tight sm:text-5xl`,children:e(`about.title`)})]})}),(0,T.jsx)(E,{delay:120,children:(0,T.jsx)(`p`,{className:`text-base leading-relaxed text-muted-foreground sm:text-lg`,children:e(`about.description`)})})]})})}function Cl(){let{t:e}=s();return(0,T.jsx)(`section`,{id:`skills`,className:`py-24 sm:py-12`,children:(0,T.jsxs)(`div`,{className:`mx-auto max-w-[1200px] px-5 sm:px-8`,children:[(0,T.jsx)(E,{children:(0,T.jsxs)(`div`,{className:`max-w-2xl`,children:[(0,T.jsx)(`p`,{className:`text-sm font-medium uppercase tracking-[0.2em] text-muted-foreground`,children:e(`skills.title`)}),(0,T.jsx)(`h2`,{className:`mt-4 text-3xl font-medium leading-tight sm:text-5xl`,children:e(`skills.heading`)}),(0,T.jsx)(`p`,{className:`mt-4 text-base text-muted-foreground sm:text-lg`,children:e(`skills.description`)})]})}),(0,T.jsx)(`div`,{className:`mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3`,children:[{titleKey:`skills.programming`,itemsKey:`skills.languages`},{titleKey:`skills.databases`,itemsKey:`skills.dbs`},{titleKey:`skills.operatingSystems`,itemsKey:`skills.os`},{titleKey:`skills.aws`,itemsKey:`skills.awsServices`},{titleKey:`skills.gcp`,itemsKey:`skills.gcpServices`}].map((t,n)=>(0,T.jsx)(E,{delay:n*70,children:(0,T.jsxs)(`article`,{className:`card-surface rounded-md h-full p-6`,children:[(0,T.jsx)(`h3`,{className:`font-display text-lg font-semibold`,children:e(t.titleKey)}),(0,T.jsx)(`ul`,{className:`mt-5 flex flex-wrap gap-2`,children:e(t.itemsKey,{returnObjects:!0}).map(e=>(0,T.jsx)(`li`,{className:`rounded-full border border-border bg-secondary px-3 py-1.5 text-xs text-muted-foreground`,children:e},e))})]})},t.titleKey))})]})})}var wl={network:b,shield:S,server:u,cloud:g,automation:C,monitor:f},Tl=[`infrastructure`,`security`,`servers`,`cloud`,`automation`,`monitoring`],El=[`Resolução rápida de incidentes`,`Documentação técnica detalhada`,`Planejamento de capacidade`,`Backup e disaster recovery`,`Otimização de performance`,`Suporte técnico especializado`];function Dl(){let{t:e}=s();return(0,T.jsx)(`section`,{id:`competencias`,className:`py-24 sm:py-5`,children:(0,T.jsxs)(`div`,{className:`mx-auto max-w-[1200px] px-5 sm:px-8`,children:[(0,T.jsx)(E,{children:(0,T.jsxs)(`div`,{className:`max-w-2xl`,children:[(0,T.jsx)(`p`,{className:`text-sm font-medium uppercase tracking-[0.2em] text-muted-foreground`,children:e(`competencies.title`)}),(0,T.jsx)(`h2`,{className:`mt-4 text-3xl font-medium leading-tight sm:text-5xl`,children:`Áreas de expertise`}),(0,T.jsx)(`p`,{className:`mt-4 text-base text-muted-foreground sm:text-lg`,children:`Áreas de expertise desenvolvidas ao longo da carreira para entregar soluções completas.`})]})}),(0,T.jsx)(`div`,{className:`mt-14 grid gap-3 sm:grid-cols-2 lg:grid-cols-3`,children:o.map((t,n)=>{let r=wl[t.icon],i=Tl[n];return(0,T.jsx)(E,{delay:n*60,children:(0,T.jsxs)(`article`,{className:`card-surface rounded-md h-full p-6`,children:[(0,T.jsx)(`span`,{className:`grid size-11 place-items-center rounded-md bg-primary/15 text-primary`,children:(0,T.jsx)(r,{className:`size-5`,"aria-hidden":`true`})}),(0,T.jsx)(`h3`,{className:`mt-5 font-display text-lg font-semibold`,children:e(`competencies.${i}.title`)}),(0,T.jsx)(`p`,{className:`mt-3 text-sm leading-relaxed text-muted-foreground`,children:e(`competencies.${i}.description`)})]})},i)})}),(0,T.jsx)(E,{delay:100,children:(0,T.jsx)(`div`,{className:`aurora mt-6 rounded-md border border-border p-8 sm:p-12`,children:(0,T.jsxs)(`div`,{children:[(0,T.jsx)(`h3`,{className:`text-2xl font-medium sm:text-3xl`,children:`Por que me escolher?`}),(0,T.jsx)(`ul`,{className:`mt-7 grid gap-3 sm:grid-cols-2`,children:El.map(e=>(0,T.jsxs)(`li`,{className:`flex items-start gap-3 text-sm text-muted-foreground`,children:[(0,T.jsx)(h,{className:`mt-0.5 size-4 shrink-0 text-primary`,"aria-hidden":`true`}),e]},e))})]})})})]})})}var Ol={phone:x,mail:y,linkedin:v,github:_};function kl(){let{t:e}=s();return(0,T.jsx)(`section`,{id:`contato`,className:`py-24 sm:py-32`,children:(0,T.jsxs)(`div`,{className:`mx-auto max-w-[1200px] px-5 sm:px-8`,children:[(0,T.jsx)(E,{children:(0,T.jsxs)(`div`,{className:`max-w-2xl`,children:[(0,T.jsx)(`p`,{className:`text-sm font-medium uppercase tracking-[0.2em] text-muted-foreground`,children:e(`contact.label`)}),(0,T.jsx)(`h2`,{className:`mt-4 text-3xl font-medium leading-tight sm:text-5xl`,children:e(`contact.heading`)}),(0,T.jsx)(`p`,{className:`mt-4 text-base text-muted-foreground sm:text-lg`,children:e(`contact.intro`)})]})}),(0,T.jsxs)(`div`,{className:`mt-14 grid gap-6 lg:grid-cols-[1.15fr_0.85fr]`,children:[(0,T.jsx)(`div`,{className:`grid gap-4 sm:grid-cols-2`,children:i.map((e,t)=>{let n=Ol[e.icon];return(0,T.jsx)(E,{delay:t*60,children:(0,T.jsxs)(`a`,{href:e.href,target:e.href.startsWith(`http`)?`_blank`:void 0,rel:`noreferrer`,className:`card-surface flex h-full rounded-md items-center gap-4 p-6`,children:[(0,T.jsx)(`span`,{className:`grid size-11 shrink-0 place-items-center rounded-md bg-primary/15 text-primary`,children:(0,T.jsx)(n,{className:`size-6`,"aria-hidden":`true`})}),(0,T.jsxs)(`span`,{className:`min-w-0`,children:[(0,T.jsx)(`span`,{className:`block text-xs uppercase tracking-widest text-muted-foreground`,children:e.label}),(0,T.jsx)(`span`,{className:`mt-1 block truncate text-sm font-medium`,children:e.value})]}),(0,T.jsx)(m,{className:`ml-auto size-4 shrink-0 text-muted-foreground`,"aria-hidden":`true`})]})},e.label)})}),(0,T.jsx)(E,{delay:120,children:(0,T.jsxs)(`div`,{className:`aurora flex h-full flex-col justify-between gap-8 rounded-md border border-border p-8`,children:[(0,T.jsxs)(`div`,{children:[(0,T.jsx)(`h3`,{className:`font-display text-xl font-semibold`,children:e(`contact.interestTitle`)}),(0,T.jsx)(`p`,{className:`mt-3 text-sm leading-relaxed text-muted-foreground`,children:e(`contact.interestDescription`)})]}),(0,T.jsx)(`div`,{className:`flex flex-col gap-3`,children:(0,T.jsx)(`a`,{href:t,target:`_blank`,rel:`noreferrer`,className:`inline-flex items-center justify-center rounded-full border border-border bg-background/40 px-6 py-3 text-sm font-semibold backdrop-blur transition-colors hover:bg-secondary`,children:e(`contact.whatsapp`)})})]})})]})]})})}function Al(){return(0,T.jsxs)(`div`,{className:`min-h-screen bg-background`,children:[(0,T.jsx)(l,{}),(0,T.jsxs)(`main`,{children:[(0,T.jsx)(xl,{}),(0,T.jsx)(Sl,{}),(0,T.jsx)(Cl,{}),(0,T.jsx)(Dl,{}),(0,T.jsx)(kl,{})]}),(0,T.jsx)(d,{})]})}export{Al as component};