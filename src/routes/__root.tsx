  ...
  head: () => ({
    meta: [
      ...
      { title: "Caio Marcondes — Analista de Sistemas & Infraestrutura" },
      {
        name: "description",
        content:
          "Portfólio profissional de Caio Marcondes, analista de sistemas e infraestrutura.",
      },
      { name: "author", content: "Caio Marcondes" },
      { property: "og:site_name", content: "Caio Marcondes" },
