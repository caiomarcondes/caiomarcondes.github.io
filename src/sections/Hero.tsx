    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6">
          <span className="block text-foreground mb-2">Eu,</span>
        ...
        <p className="text-xl sm:text-2xl md:text-3xl text-muted-foreground font-light mb-4">
          Analista de Redes & Infraestrutura
        </p>

        {/* Description */}
        <p className="max-w-2xl mx-auto text-base sm:text-lg text-muted-foreground/80 mb-10 leading-relaxed">
          Ao longo da minha trajetória, desenvolvi habilidades em hardware e software 
          e busco constantemente aprimorar minhas capacidades com cada novo desafio. 
          Acredito no poder da <span className="text-violet-400">criatividade</span>,{' '}
          <span className="text-fuchsia-400">inovação</span> e{' '}
          <span className="text-cyan-400">colaboração</span> para gerar resultados 
